...
func (m MovieModel) Get(id int64) (*Movie, error) {
	// The PostgreSQL bigserial type we're using for the movie ID starts
	// auto-incrementing at 1 by default, sowe know that no movies will have ID values
	// less than that. To avoid making unnecessary database call, we take shortcut
...
func (m MovieModel) Update(movie *Movie) error {
	...
	args := []interface{}{
		...
		pq.Array(movie.Genres),
		movie.ID,
		movie.Version, // Add the expeted movie version.
	}
...
func (m MovieModel) GetAll(title string, genres []string, filters Filters) ([]*Movie, Metadata, error) {
	...
	// Pass the title and genres as the palceholder parameters values.
