...
func (app *application) createMovieHandler(w http.ResponseWriter, r *http.Request) {
	...
	// validated movie struct. This will create a record in the databse and update the
	// movie struct with the system-generated onformation.
...
func (app *application) updateMovieHandler(w http.ResponseWriter, r *http.Request) {
	...
	// Read the JSON request body data into the input strutc.
	err = app.readJSON(w, r, &input)
	if err != nil {
		app.badRequestResponse(w, r, err)
		return
	...
	// Copy the values from the request body to the appropiate fields of the movie
