...
import (
	...
	"github.com/Michael-Wilburn/greenlight/internal/jsonlog"
	"github.com/Michael-Wilburn/greenlight/internal/mailer"
	_ "github.com/lib/pq"
)
...
// Add a models field to hold our Model struct.
...
func main() {
	// Declare an intance the config struct.
	var cfg config

	// Read the value of the port and env command-line flags into the config struct. We
	// default to using the port 4000 and the enviroment "development" if no
	// corresponding flags are provided.
	flag.IntVar(&cfg.port, "port", 4000, "API server port")
	flag.StringVar(&cfg.env, "env", "development", "Environment(development|staging)")
	...
	flag.StringVar(&cfg.smtp.sender, "smtp-sender", os.Getenv("GREENLIGHT_SMTP_EMAIL"), "SMTP sender")
